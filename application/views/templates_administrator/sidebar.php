  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('administrator/dashboard'); ?>">
        ...
        <div class="sidebar-brand-text mx-1">SIM AKADEMIK</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('administrator/mahasiswa') ?>">Siswa</a>
            <a class="collapse-item" href="<?= base_url('administrator/dosen') ?>">Guru</a>
            ...
            <a class="collapse-item" href="<?= base_url('administrator/prodi') ?>">Kelas</a>
            <a class="collapse-item" href="<?= base_url('administrator/matakuliah') ?>">Mata Pelajaran</a>
            <a class="collapse-item" href="<?= base_url('administrator/krs') ?>">Input Jadwal</a>
            <a class="collapse-item" href="<?= base_url('administrator/nilai/input_nilai') ?>">Input Nilai</a>
            <a class="collapse-item" href="<?= base_url('administrator/nilai') ?>">Hasil Nilai</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('administrator/tentang_kampus') ?>">Tentang Sekolah</a>
          ...
          <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div>
                    ...
                    <span class="font-weight-bold">information receipt of new students has been held!</span>
                  </div>
                </a>
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="mr-3">
                  ...
                  <div>
                    <div class="small text-gray-500">June 2, 2023</div>
                    immediately reply to the message from the user!
                  </div>
                </a>
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="mr-3">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Annisa Nurhaniyah</span>
